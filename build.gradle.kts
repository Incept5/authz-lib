...
tasks.register("publishJitPackModules") {
    dependsOn(":authz-core:publishToMavenLocal", ":authz-quarkus:publishToMavenLocal", ":authz-testing:publishToMavenLocal")
}
    ...
    publications {
        create<MavenPublication>("mavenRoot") {
            ...
            pom {
                ...
                description.set("authz  library for Quarkus applications")
                ...
                withXml {
                    ...
                    project(":authz-quarkus").let { subproject ->
                        val dependency = dependencies.appendNode("dependency")
                        dependency.appendNode("groupId", "com.github.incept5.authz-lib")
